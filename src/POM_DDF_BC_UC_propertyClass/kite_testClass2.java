...
public class kite_testClass2 extends baseclass_222
{
	...
	@BeforeMethod
	public void tc11() throws EncryptedDocumentException, IOException
	{
		
		//s1.inputk1username(utilityclass222.exceINFO(0, 0));
	s1.inputk1username(utilityclass222.getdatafromPF("un"));
	    s1.inputk2password(utilityclass222.getdatafromPF("pass"));
		s1.clickk3loginbutton();
		
		s2.inputk2pin(utilityclass222.getdatafromPF("pin"));
